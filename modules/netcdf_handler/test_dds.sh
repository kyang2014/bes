...
besstandalone  -c tests/bes.conf -i tests/nc/fnoc1.nc.dods.constraint.bescmd 
#besstandalone  -c tests/bes.conf -i tests/nc/fnoc1.nc.dods.constraint.bescmd | getdap -M -
#besstandalone  -c tests/bes.conf -i tests/nc/fnoc1.nc.dods.constraint.bescmd | getdap -M - 
#besstandalone -d"cerr,all" -c tests/bes.conf -i tests/nc/fnoc1.nc.dods.constraint.bescmd | getdap -M - 
